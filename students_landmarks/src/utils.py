...
def load_one_annotation(anns_file: str, img_index: int = 0):
    """
...
def get_one_image_from_dataset(anns_file: str, studentLandmarks: StudentsLandmarks, img_index: int):
    anns = load_one_annotation(anns_file, img_index)
