...
import haar from "/assets/haarcascade_frontalface_default.xml?raw";
...
export function detectFace(src: Mat): { mat: Mat, offset: Rect } | undefined {
	...
	console.log("SELECTED FACE ", largestFaceIndex);
...
function downloadHaarCascade(): void {
	cv.FS_createDataFile('/', xml_path, haar, true, false, false);
}
